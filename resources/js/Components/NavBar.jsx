...
const navigation = [
    ...
    { name: "All Games", href: "/all", current: false },
...
export default function NavBar({ user }) {
    ...
    return (
        <Disclosure
            as="nav"
            className="fixed top-0 z-50 w-full bg-gray-800">
            {({ open }) => (
                <>
                    <div className="mx-auto max-w-7xl px-2 sm:px-4 lg:divide-y lg:divide-gray-700 lg:px-8">
                        <div className="relative flex h-16 justify-between">
                            <div className="relative z-10 flex px-2 lg:px-0">
                                <div className="flex flex-shrink-0 items-center">{/* Your SVG logo here */}</div>
                            </div>
                            ...
                            {user ? (
                                ...
                                <div className="hidden lg:relative lg:z-10 lg:ml-4 lg:flex lg:items-center">
                                    ...
                                    <a
                                        href="/register"
                                        className="ml-4 rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
                                        Register
                                    </a>
                                </div>
                            )}
